...
1. **Access the Template:** Open the [BridgeMail Master Spreadsheet](https://docs.google.com/spreadsheets/d/12k8AAtDM4alEI6LFXGW6boerH_lT5J9APZVl6DvWZL4/edit?usp=sharing).
...
1. **Create Spreadsheet:** Open a new [Google Sheet](https://sheets.new).
